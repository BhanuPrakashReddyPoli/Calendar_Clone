  ...
  return (
    <div className="modal">
      <div className="modal-content">
        ...
        <input type="text" placeholder="Event Title" value={eventText} onChange={(e) => setEventText(e.target.value)} />
        <button onClick={() => addOrEditEvent(modalData.day, modalData.time, eventText)}>Save</button>
